...
console.log(`(toExponential) Number 123456 in exponential notation: ${exponential(123456, 2)}`);
// Returns a string representing the number in fixed-point notation.
const fixed = (num, decimals) => Number.parseFloat(num).toFixed(decimals);
console.log(`(toFixed) Number 12.12345 in fixed-point notation: ${fixed(12.12345 , 4)}`);
// Returns a string representing the number to a specified precision in fixed-point or exponential notation
const precision = (num, value) => num.toPrecision(value);
